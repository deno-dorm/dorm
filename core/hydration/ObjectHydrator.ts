import type { EntityData, EntityMetadata, EntityProperty } from '../typings.ts';
import { Hydrator } from './Hydrator.ts';
import { Collection } from '../entity/Collection.ts';
import { Reference, ScalarReference } from '../entity/Reference.ts';
