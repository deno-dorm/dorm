...
import type { CreateOptions, EntityManager, MergeOptions } from '../EntityManager.ts';
import type { AssignOptions } from './EntityAssigner.ts';
import type {
  EntityData,
  EntityName,
  Primary,
...
import type {
  ...
  UpsertManyOptions,
  UpsertOptions,
} from '../drivers/IDatabaseDriver.ts';
