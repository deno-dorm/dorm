...
import { Collection, EntityHelper, EntityIdentifier, helper, Reference } from '../entity/index.ts';
import { ChangeSet, ChangeSetType } from './ChangeSet.ts';
import { ChangeSetComputer } from './ChangeSetComputer.ts';
import { ChangeSetPersister } from './ChangeSetPersister.ts';
import { CommitOrderCalculator } from './CommitOrderCalculator.ts';
import { Utils } from '../utils/Utils.ts';
import type { EntityManager } from '../EntityManager.ts';
import { Cascade, EventType, LockMode, ReferenceKind } from '../enums.ts';
import { OptimisticLockError, ValidationError } from '../errors.ts';
import type { Transaction } from '../connections/index.ts';
import { type EventManager, TransactionEventBroadcaster } from '../events/index.ts';
import { IdentityMap } from './IdentityMap.ts';
import type { LockOptions } from '../drivers/IDatabaseDriver.ts';
import type { EntityComparator, MetadataStorage, Platform } from '../mod.ts';
