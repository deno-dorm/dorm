...
import type { CheckDef, Column, IndexDef, TableDifference, Table, ForeignKey, MySqlTableBuilder } from '../../typings.ts';
import { EnumType, StringType, TextType, type Dictionary, type Type, BigIntType, Utils } from '@dorm/core';
import type { AbstractSqlConnection } from '../../AbstractSqlConnection.ts';
import { SchemaHelper } from '../../schema/SchemaHelper.ts';
import type { DatabaseSchema } from '../../schema/DatabaseSchema.ts';
import type { DatabaseTable } from '../../schema/DatabaseTable.ts';
