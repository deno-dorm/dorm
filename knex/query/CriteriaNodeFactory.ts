...
import { ObjectCriteriaNode } from './ObjectCriteriaNode.ts';
import { ArrayCriteriaNode } from './ArrayCriteriaNode.ts';
import { ScalarCriteriaNode } from './ScalarCriteriaNode.ts';
import type { ICriteriaNode } from '../typings.ts';
